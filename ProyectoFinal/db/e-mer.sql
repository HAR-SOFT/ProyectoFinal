...
--
-- Table structure for table `hec_cursos_temas_subtemas_ejercicios`
--

DROP TABLE IF EXISTS `hec_cursos_temas_subtemas_ejercicios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hec_cursos_temas_subtemas_ejercicios` (
  `nombre_curso` varchar(50) NOT NULL,
  `nombre_tema` varchar(20) NOT NULL,
  `nombre_subtema` varchar(20) NOT NULL,
  `nombre_ejercicio` varchar(20) NOT NULL,
...
--
-- Dumping data for table `hec_cursos_temas_subtemas_ejercicios`
--

LOCK TABLES `hec_cursos_temas_subtemas_ejercicios` WRITE;
/*!40000 ALTER TABLE `hec_cursos_temas_subtemas_ejercicios` DISABLE KEYS */;
/*!40000 ALTER TABLE `hec_cursos_temas_subtemas_ejercicios` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-07-23 13:35:35
